...
int main() {
  ...
  root.insert_vertex(Vertex(Vec3f(0.45,0.45,0.45), Material(RGBi("white"), 1.2, 0.2, "reflective", 1.0)), false);
  root.insert_vertex(Vertex(Vec3f(0.45,0.55,0.45), Material(RGBi("white"), 1.2, 0.2, "reflective", 1.0)), false);
  root.insert_vertex(Vertex(Vec3f(0.55,0.45,0.45), Material(RGBi("white"), 1.2, 0.2, "reflective", 1.0)), false);
  root.insert_vertex(Vertex(Vec3f(0.55,0.55,0.45), Material(RGBi("white"), 1.2, 0.2, "reflective", 1.0)), false);
  root.insert_vertex(Vertex(Vec3f(0.45,0.45,0.55), Material(RGBi("white"), 1.2, 0.2, "reflective", 1.0)), false);
  root.insert_vertex(Vertex(Vec3f(0.45,0.55,0.55), Material(RGBi("white"), 1.2, 0.2, "reflective", 1.0)), false);
  root.insert_vertex(Vertex(Vec3f(0.55,0.45,0.55), Material(RGBi("white"), 1.2, 0.2, "reflective", 1.0)), false);
  root.insert_vertex(Vertex(Vec3f(0.55,0.55,0.55), Material(RGBi("white"), 1.2, 0.2, "reflective", 1.0)), false);
